...
description: "This document describes what new chains need to do the support Skip API"
---
 ...
 **What if I don't want to run my own relayers?**
 ...
 Just contact Skip ([support@skip.money](support@skip.money)) or tg:@bpiv400
