 ...
 **What does it cost?**
 ...
 The Skip API is free to use and integrate with. You will have very limited access if you do not have an API key from us. Please join our Discord and request one: [https://skip.money/discord](https://skip.money/discord)
</Info>

## 3 Basic Ways to Use Skip API

There are 3 ways to leverage Skip API to build cross-chain swapping & transferring experiences, depending on whether you're optimizing for control or for integration speed: 
