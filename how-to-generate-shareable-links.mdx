...
* To see supported chains, you can use [https://api.skip.money/v1/info/chains](https://api.skip.money/v1/info/chains) see [docs](/api-reference/info/get-v1infochains)
* To see supported assets, you can use [https://api.skip.money/v1/fungible/assets](https://api.skip.money/v1/fungible/assets) see [docs](/api-reference/getassets)
