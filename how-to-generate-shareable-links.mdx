...
* To see supported chains, you can use [https://api.skip.money/v1/info/chains](https://api.skip.money/v1/info/chains) see [docs](/reference/getchains)
* To see supported assets, you can use [https://api.skip.money/v1/fungible/assets](https://api.skip.money/v1/fungible/assets) see [docs](/reference/getassets)
