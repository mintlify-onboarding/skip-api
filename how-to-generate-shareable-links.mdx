...
description: "This guide provides step-by-step instructions to generate IBC.fun shareable links."
---
...
Instead of creating a route and sharing it via [https://ibc.fun](https://ibc.fun), you can create a sharable link with the following parameters of your choice: `src_chain`, `src_asset`, `dest_chain`, `dest_asset`, `amount_in`, and `amount_out`.

* To see supported chains, you can use [https://api.skip.money/v1/info/chains](https://api.skip.money/v1/info/chains) see [docs](/api-reference/info/get-v2infochains)
* To see supported assets, you can use [https://api.skip.money/v1/fungible/assets](https://api.skip.money/v1/fungible/assets) see [docs](api-reference/fungible/get-v2fungibleassets)

**Query Base URL:** [https://ibc.fun/](https://ibc.fun/)
...
**Example Shareable Link:** [https://ibc.fun?src\_chain=cosmoshub-4&src\_asset=uatom&dest\_chain=pacific-1&dest\_asset=usei&amount\_in=1](https://ibc.fun?src%5Fchain=cosmoshub-4&src%5Fasset=uatom&dest%5Fchain=pacific-1&dest%5Fasset=usei&amount%5Fin=1)
