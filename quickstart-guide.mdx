...
For detailed information on all the Skip API endpoints and functionality, please see our [reference docs](/reference/getchains). 
 ...
 **Understanding the Route Response**
 ...
 The route response contains a ton of information about how the user can move from their source chain & token to their destination. For more information, see [/v2/fungible/route](/reference/getroutev2) reference docs.
